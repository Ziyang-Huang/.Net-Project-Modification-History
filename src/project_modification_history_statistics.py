...
from tools import normalize_rel, nprint, vprint
...
def find_projects(
    root_dir: str, selected_exts: Tuple[str, ...], years: List[str], ignore_patterns: List[str]
) -> List[Project]:
    projects = []
...
def aggregate_modifications(projects: List[Project]) -> List[dict]:
    data: List[dict] = []
